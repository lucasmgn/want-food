...
class RestaurantITRegistration {
    ...
    @Test
    void deveRetornarStatus200_QuandoConsultarrestaurants() {
        RestAssured.given()
    ...
    @Test
    void deveRetornarStatus201_QuandoCadastrarrestaurant() {
        RestAssured.given()
    ...
    @Test
    void deveRetornarStatus400_QuandoCadastrarrestaurantSemrateShipping() {
        RestAssured.given()
    ...
    @Test
    void deveRetornarStatus400_QuandoCadastrarrestaurantSemKitchen() {
        RestAssured.given()
    ...
    @Test
    void deveRetornarStatus400_QuandoCadastrarrestaurantComKitchenInexistente() {
        RestAssured.given()
    ...
    @Test
    void deveRetornarRespostaEStatusCorretos_QuandoConsultarrestaurantExistente() {
        RestAssured.given()
    ...
    @Test
    void deveRetornarStatus404_QuandoConsultarrestaurantInexistente() {
        RestAssured.given()
