...
import com.wantfood.aplication.api.model.CozinhasXmlWrapper;
...
public class CozinhaController {
	 ...
	 * public ResponseEntity<Cozinha> busca (@PathVariable Long cozinhaId) {
	 * Cozinha cozinha = cozinhaRepository.porId(cozinhaId);
	 * return ResponseEntity.status(HttpStatus.OK).body(cozinha); //responde o status ok e o body de cozinha
	 * return ResponseEntity.ok(cozinha);
	 * */
	}
	
	/*
	 * Colocando o status como create (status 201),
	 *  e irá retornar a cozinha criada
	 * */
	@PostMapping
